...
<body>
				...
				<div class="col-12">
					...
					<div class="site-logo">
						...
						<?php 
                            ...
                            {
                                echo "<li><a href='normalplantSale.php'>Home</a></li>";
                            }
                            ?>
							 <?php 
                            if($_SESSION['type']=='builder')
                            ...
                            {
                                echo "<li><a href='normalplantSale.php'>FOR SALE</a></li>";
                            }
                            ?>
                            ...
                            {
                                echo "<li><a href='normalplantSale.php'>FOR RENT</a></li>";
                            }
                            ?>
	...
	<!-- Page top section -->
	<section class="page-top-section set-bg" data-setbg="https://wallpaperaccess.com/full/343990.jpg">
...
include('indexDB.php');
$x=$_GET["id"];
$sql = "SELECT * FROM plant natural join rent where plant_id=$x";
...
$a="SELECT rent_amount FROM rent where plant_id=$x";
$r1 = $conn->query($a);
$r2 = mysqli_fetch_assoc($r1);
$_SESSION["amt"]=$r2['rent_amount'];
$b="SELECT name from login where UID=(SELECT uid from plant where plant_id=$x)";
$r4=$conn->query($b);
...
?>
	...
	<section class="page-section">
		<div class="container">
          ...
          <div class="single-list-content">
						<div class="row">
							<div class="col-xl-8 sl-title">
								...
								<p><i class="fa fa-map-marker"></i><?php echo $row['pname'] ?></p>
							</div>
							<div class="col-xl-4">
						...
						<h3 class="sl-sp-title">Plant Details</h3>
						<div class="row property-details-list">
							<div class="col-md-4 col-sm-6">
								<p><i class="fa fa-th-large"></i><?php echo $row['area']."area" ?></p>
						...
						<h3 class="sl-sp-title">Plant scientific name</h3>
						<div class="row property-details-list">
							<div class="col-md-12 col-sm-6">
								<p><i class="fa fa-check-circle-o"></i><?php echo $row['sciname'] ?></p>
							</div>
						</div>
						...
						<div id="accordion" class="plan-accordion">
							<div class="panel">
								<div class="panel-header" id="headingOne">
									<button class="panel-link" data-toggle="collapse" data-target="#collapse3" aria-expanded="flase" aria-controls="collapse3"><span><?php echo $row['area']." area"; ?></span>	<i class="fa fa-angle-down"></i>
									</button>
								</div>
          ...
          <?php
        	$x=$_GET["id"];
        	$sql1="SELECT * FROM plant natural join rent where plant_id=$x";
