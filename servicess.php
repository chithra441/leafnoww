      ...
      <div class="row">
        <div class="column">
          <div class="card">
            ...
            <p><a href="form.php">
            Fill the form to submitur services</a>
            </p>
          </div>
        </div>
        <div class="column">
          <div class="card">
            ...
            <h3>Service Heading</h3>
            <p>
         <a href="normalplantSale.php"> selling / buying / donate plants/seeds</a>
            </p>
          </div>
        </div>
        <div class="column">
          <div class="card">
            ...
            <h3>Service Heading</h3>
            <p>
            <a href="addtopic.html"> disscussion page</a>
            </p>
          </div>
        </div>
        <div class="column">
          <div class="card">
            ...
            <h3>Service Heading</h3>
            <p>
             <a href="payment.php"> donation for every pdf</a>
            </p>
          </div>
        </div>
    </section>
