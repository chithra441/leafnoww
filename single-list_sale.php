...
<body>
	...
	<!-- Page top section -->
	<section class="page-top-section set-bg" data-setbg="https://images.unsplash.com/photo-1490197415175-074fd86b1fcc?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxleHBsb3JlLWZlZWR8Mjl8fHxlbnwwfHx8&w=1000&q=80">
...
include('indexDB.php');
$x=$_GET["id"];
$sql = "SELECT * FROM plant natural join sale where plant_id=$x";
...
$a="SELECT totalcost FROM SALE where plant_id=$x";
$r1 = $conn->query($a);
...
?>
	...
	<section class="page-section">
          ...
          <div class="single-list-content">
						<div class="row">
							<div class="col-xl-8 sl-title">
								...
								<p><i class="fa fa-map-marker"></i><?php echo $row['pfamily'] ?></p>
							</div>
							<div class="col-xl-4">
        ...
        include('indexDB.php');
        	$x=$_GET["id"];
        	$sql1="SELECT * FROM plant natural join sale where plant_id=$x";
