...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["area"])) {
	...
	header('Location: normalplantRent.php?message=1');
}

if( !empty( $_GET['id'])){
	$q3='select * from flat where plant_id="'.$_GET['id'].'"';
    $r4=$conn->query($q3);
    $x=mysqli_fetch_array($r4,MYSQLI_ASSOC);

	$q4='select * from rent where plant_id="'.$_GET['id'].'"';
    $r5=$conn->query($q4);
				...
				<div class="col-12">
					...
					<div class="site-logo"><h3>LEAFNOW</h3></div>
						...
						<ul class="main-menu">
							...
							{
								echo "<li><a href='normalplantSale.php'>View property</a></li>";
							}
							else
							{
...
<td colspan=2>
<center><font size=5><b>EDIT PLANTS</b></font></center>
</td>
</tr>
<input type="hidden" name="plant_id" value="<?php echo $x['plant_id'];?>"/>
<tr>
<td><b>Location:</b></td>
